    ...
    <div className="flex items-center justify-center space-x-8">
      ...
      <div className="w-16 h-28 relative">
        <button 
          ...
          className="w-full h-6 bg-gray-700 hover:bg-gray-600 rounded-t-lg flex items-center justify-center text-white transition-colors absolute top-0"
        >
        ...
        <input
          ...
          className="w-full h-16 text-3xl font-bold text-center bg-gray-800 border-2 border-gray-600 border-t-0 border-b-0 text-white appearance-none overflow-hidden absolute top-6"
        ...
        <button 
          ...
          className="w-full h-6 bg-gray-700 hover:bg-gray-600 rounded-b-lg flex items-center justify-center text-white transition-colors absolute bottom-0"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <line x1="5" y1="12" x2="19" y2="12"></line>
          </svg>
