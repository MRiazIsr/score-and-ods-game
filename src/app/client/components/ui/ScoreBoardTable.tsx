  ...
  return (
      <div className="w-full rounded-lg border border-gray-700">
        ...
        <div className="lg:hidden divide-y divide-gray-700">
          <div className="text-[15px] text-gray-500 text-center">
            Exact: 3pts • Diff: 2pts • Result: 1pt
          </div>
          {/* Mobile Header */}
          <div className="bg-gray-800 p-3">
            <div className="flex justify-between items-center text-xs font-medium text-gray-300 uppercase mb-1">
          ...
          {hasEntries ? (
              data.entries.map((entry, index) => (
                  <div
                      key={entry.userId}
                      className={`p-3 ${entry.userId === currentUserId ? 'bg-blue-900 bg-opacity-30' : 'bg-gray-900'}`}
                  >
                    {/* Main row with rank, name, total points */}
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center space-x-3">
                  <span className="font-bold text-white text-sm w-6">
                    {index + 1}
                  </span>
                  ...
                  {entry.points}
                    ...
                    {/* Stats row */}
                    <div className="flex justify-between text-xs text-gray-400 pl-9">
              ...
              <div className="p-6 text-center bg-gray-900">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <p className="text-gray-500 text-xs">
                    Waiting for completed matches with predictions.
                  </p>
                </div>
              </div>
          )}
